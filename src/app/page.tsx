        ...
        <FadeInUpBox delay={0.2}>
          <section className="bg-gray-50 py-16 px-6">
            <div className="max-w-7xl mx-auto flex flex-wrap justify-center gap-8">
              <Link href="/trade/calibrated-stones" className="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.5rem)] group block relative h-80 overflow-hidden bg-white shadow-sm border border-gray-100 p-8 flex flex-col justify-center items-center text-center transition-shadow hover:shadow-md">
