    ...
    <div className="flex flex-col md:flex-row gap-4 px-5 mt-6">
      <div className="w-full md:w-2/3 pr-2">
        <div className="p-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-7/12 flex flex-col items-center">
              <ZoomImage imageUrl={product?.image_url} />
        ...
        <div className="mt-9 flex flex-wrap gap-9 justify-around">
          <Image
            src={"https://d3kinlcl20pxwz.cloudfront.net/dime-stones/71733.jpg"}
            h={300}
            w={300}
            radius="md"
            fit="fill"
          ...
          <Image
            src={
              "https://d3kinlcl20pxwz.cloudfront.net/images-stones/71733/FL.jpg?format=webp"
            }
            h={300}
            w={300}
            radius="md"
      ...
      <div className="w-full md:w-1/3">
        <div className="sticky top-5">
          <div className="flex flex-col gap-4">
            ...
            <Checkbox label="Match For Size and Color" color="violet" />
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col text-sm">
                  ...
                  <Text size="sm" c="dimmed">
                    Your satisfaction is our priority — let us help you find the
                    perfect stone in person.
                  </Text>
                </div>
                <Button color="violet" size="xs" className="self-start">
                  Request
                </Button>
              </div>
            </Alert>
            ...
            <Button color="violet" onClick={addProductToCart} fullWidth>
              Add To Cart
            </Button>
            <Button
